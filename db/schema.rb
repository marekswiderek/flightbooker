...
ActiveRecord::Schema[7.2].define(version: 2024_12_17_143200) do
  ...
  create_table "passengers", primary_key: "passport_no", id: :string, force: :cascade do |t|
    t.string "name"
    t.string "surname"
    t.string "email"
    t.datetime "created_at", null: false
  ...
  add_foreign_key "bookings", "passengers", primary_key: "passport_no"
